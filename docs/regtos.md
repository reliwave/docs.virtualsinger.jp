...
1. 本サーバーのモデレーター/管理者は、Reliwave P.S.ロール保持者 です。
...
5. 利用規約に違反し、凍結された者が悪質な場合、第三者機関（他のサーバーやFediverseサーバー運営組織）にぼかろすきー Regacyに登録されたすべての情報を提供することがあります。
6. Fediverseの特性上、リモートサーバーで凍結されたからといって、ぼかろすきー Regacyでも凍結することはできません。
